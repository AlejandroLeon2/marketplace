...
function createProduct() {
    return __awaiter(this, void 0, void 0, function () {
        var name_1, description, unit_amount, currency, product, price, error_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 3, , 4]);
                    name_1 = "Libre TypeScript";
                    description = "Creación de un producto de prueba";
                    unit_amount = 12000;
                    currency = "pen";
                ...
                case 3:
                    ...
                    if (error_1 instanceof Error) {
                        console.error("❌ Error creando producto:", error_1.message);
                    }
                    else {
                        console.error("❌ Error desconocido:", error_1);
                    }
                    return [3 /*break*/, 4];
